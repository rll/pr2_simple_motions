...
class LatestJointStates:
    ...
    def __init__(self):
        ...
        s = rospy.Service('return_joint_state', ReturnJointState, self.return_joint_state_srv)
    ...
    def return_joint_state_srv(self, req):
        (found, position, velocity, effort) = self.return_joint_state(req.name)
        return ReturnJointStateResponse(found, position, velocity, effort)
